...
import { getProductBrand, getProductCategory, getProductDetail, getProductGroup, getProductList, updateProduct } from "../../datasource/ProductDatasource";
...
export const DistributionPageEdit: React.FC = (props: any) => {
    ...
    const dataGroup1 = [
        ...
        },
        {
            ...
            customInput: (
                <Select 
                    options={categories?.map((cat: ProductCategoryEntity) => ({ label: cat.productCategoryName, value: cat.productCategoryId }))}
                />
            )
        }
    ]
    ...
    const dataGroup2 = [
        ...
        },
        {
            ...
            value: priceFormatter(unitPrice || '')
        },
    ]
                ...
                <CardContainer>
                    ...
                    <Container>
                        ...
                        >   
                            ...
                            <Row gutter={24}>
                                {dataGroup1.map((d, i) => <ProdFormItem {...d} key={i}/>)}
                            </Row>
                            <PriceContainer>
                                ...
                                <Row gutter={24}>
                                    {dataGroup2.map((d, i) => <ProdFormItem {...d} key={i}/>)}
                                </Row>
                                <Text color='primary' fontWeight={700}>
                                    PACKAGE SIZE
                                </Text>
                                <Row gutter={24}>
                                    {dataGroup3.map((d, i) => <ProdFormItem {...d} key={i}/>)}
                                </Row>
                            </PriceContainer>
                            <br/>
                            <Form.Item label={'คุณสมบัติและ ประโยชน์'} name='description' initialValue={description}>
                                <TextArea/>
                            </Form.Item>
                            <br/>
                            ...
                            <Row align='middle' justify='end'>
                                <Button type='primary' htmlType='submit' size='large' style={{ width: 136}} loading={uploading}>
                                    บันทึก
                                </Button>
                            </Row>
                        </Form>
