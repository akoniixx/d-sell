...
export const ProductListItemEntity_INIT: ProductListItemEntity = {
  productId: 0,
  companyId: 0,
  locationId: 0,
  productBrandId: 0,
...
export class ProductListItemEntityUtil {
  fromEntity(data: ProductListItemEntity): ProductListItemEntity {
    const itemEntity = {
